...
<section class="hero-slider">
  ...
  <div class="slide" style="background-image: url('assets/images/slide2.png');">
    <div class="hero-content">
      ...
      <a href="services.php" class="hero-btn">Our Services</a>
    </div>
  </div>
  ...
  <div class="slide" style="background-image: url('assets/images/slide4.jpg');">
    <div class="hero-content">
      ...
      <a href="services.php" class="hero-btn">Explore Imaging Services</a>
    </div>
  </div>
...
<div class="floating-cards">
  <div class="card-container">
    ...
    <div class="card">
      ...
      <div class="card-logo">
        <img src="assets/images/plm-logo-no_bg.png" alt="Polyclinique la Médicale Logo">
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-content">
        ...
        <a href="lab-result.html" class="apply-btn">Apply</a>
      </div>
...
<section id="services">
  ...
  <!-- Hospitalization -->
  <div class="service-card" style="background-image: url('../assets/images/hospitalization.jpg');">
    <div class="card-content">
      <h2>Hospitalization</h2>
      <p>Comfortable and well-equipped patient rooms for quality care.</p>
      <a href="services.php" class="card-btn">Learn More</a>
    </div>
  </div>

  <!-- Physiotherapy -->
  <div class="service-card" style="background-image: url('../assets/images/physio.jpg');">
    <div class="card-content">
      <h2>Physiotherapy</h2>
      <p>Rehabilitation programs to restore movement and strength.</p>
      <a href="services.php" class="card-btn">Learn More</a>
    </div>
  </div>

  <!-- Nebulization -->
  <div class="service-card" style="background-image: url('../assets/images/nebulization.jpg');">
    <div class="card-content">
      <h2>Nebulization</h2>
  ...
  <!-- Orthopedics -->
  <div class="service-card" style="background-image: url('../assets/images/orthopedics.jpg');">
    <div class="card-content">
      <h2>Orthopedics</h2>
  ...
  <!-- Maternity -->
  <div class="service-card" style="background-image: url('../assets/images/maternity.jpg');">
    <div class="card-content">
      <h2>Maternity</h2>
